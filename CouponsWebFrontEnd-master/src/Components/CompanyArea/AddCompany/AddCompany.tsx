...
import {companyStore, createAddCompanyAction} from "../../../Redux/CompanyState";
...
function AddCompany(): JSX.Element {
    ...
    function send(company : CompanyModel){
        ...
        adminService.addCompany(company).then(()=>{
        ...
        <div className="AddCompany">
			<form onSubmit={handleSubmit(send)} className="form">
                ...
                <input type="password" {...register ( "password", {
                    ...
                    maxLength : {value : 18, message : "PASSWORD CANNOT BE LONGER THAN 18 LETTERS"}})}/><br/>
