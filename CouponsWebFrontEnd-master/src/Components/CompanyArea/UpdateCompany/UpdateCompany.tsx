...
import {companyStore, createUpdateCompanyAction} from "../../../Redux/CompanyState";
...
function UpdateCompany() : JSX.Element {
    ...
    function send(company : CompanyModel){
        ...
        companyStore.dispatch(createUpdateCompanyAction(company));
        adminService.updateCompany(company)
        .then(()=>{
            notificationService.success(company.name + " UPDATED")
