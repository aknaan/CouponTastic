...
function AllCustomers(): JSX.Element {
    ...
    useEffect(() => {
        ...
        return () => {
            unsubscribe(); // Unsubscribe from the store when the component is unmounted
        };
    }, []);
    ...
    return (
        <div className="AllCustomers">
            ...
            <span className="bottom-left-button-block">
                <Link className="left-button" onClick={backHome} component="button" color="inherit" underline="hover">BACK</Link>
