...
import "./Routing.css";
import CouponDetailsPage from "../../CouponArea/CompanyCouponDetailsPage/CouponDetailsPage";
...
function Routing(): JSX.Element {
    ...
    return (
        <div className="Routing">
            {currentUser != null &&
                <div> {/* gives the user only their allowed routes by the client-type in their User Model */}
                    ...
                    <div className="Company Routing">{currentUser.type === "COMPANY" &&
                        <Routes>
                            ...
                            <Route path="/CouponPage/:id" element={<CouponDetailsPage/>}/>
